...
export function UserAccountModal({ open, onOpenChange, initialTab = 'businesses' }: UserAccountModalProps) {
  ...
  // Load data when modal opens and reset tab
  useEffect(() => {
    if (open) {
